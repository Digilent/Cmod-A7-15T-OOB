...
--Command     : generate_target user_15t_wrapper.bd
--Design      : user_15t_wrapper
...
end user_15t_wrapper;

architecture STRUCTURE of user_15t_wrapper is
  component user_15t is
  port (
    cellular_ram_addr : out STD_LOGIC_VECTOR ( 18 downto 0 );
    cellular_ram_ce_n : out STD_LOGIC;
